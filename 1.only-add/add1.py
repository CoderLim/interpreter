...
class Interpreter(object):
    ...
    def get_next_token(self):
        ...
        # get a character at the position self.pos and defcide
    ...
    def expr(self):
        ...
        # at this point INTEGER PLUS/SUB INTEGER sequence of tokens has been
        # successfully found and the method can just return the result of adding
        # two integers, thus effectively interpreter client input
        if op.value == '+':
